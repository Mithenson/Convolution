...
namespace Zenject
{
        ...
        where TDerived : Installer<TDerived>
    {
        ...
        {
            await container.Instantiate<TDerived>().InstallBindings();
        }
    }
    ...
    {
        public static async UniTask Install(DiContainer container, TParam1 p1)
        {
            await container.InstantiateExplicit<TDerived>(
    ...
    {
        public static async UniTask Install(DiContainer container, TParam1 p1, TParam2 p2)
        {
            await container.InstantiateExplicit<TDerived>(
    ...
    {
        public static async UniTask Install(DiContainer container, TParam1 p1, TParam2 p2, TParam3 p3)
        {
            await container.InstantiateExplicit<TDerived>(
    ...
    {
        public static async UniTask Install(DiContainer container, TParam1 p1, TParam2 p2, TParam3 p3, TParam4 p4)
        {
            await container.InstantiateExplicit<TDerived>(
    ...
    {
        public static async UniTask Install(DiContainer container, TParam1 p1, TParam2 p2, TParam3 p3, TParam4 p4, TParam5 p5)
        {
            await container.InstantiateExplicit<TDerived>(
