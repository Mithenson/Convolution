...
namespace Zenject
{
        ...
        : FactorySubContainerBinderWithParams<TContract>
    {
        ...
        public NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder ByNewPrefabMethod(
            Func<InjectContext, UnityEngine.Object> prefabGetter, Install<TParam1, TParam2> installerMethod)
        {
            var gameObjectInfo = new GameObjectCreationParameters();
        ...
        public NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder ByNewPrefabMethod(
            UnityEngine.Object prefab, Install<TParam1, TParam2> installerMethod)
        {
        ...
        public NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder ByNewPrefabResourceMethod(
            string resourcePath, Install<TParam1, TParam2> installerMethod)
        {
