...
namespace Zenject
{
        ...
        : FactorySubContainerBinderBase<TContract>
    {
        ...
        public NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder ByNewGameObjectMethod(Install installerMethod)
        {
        ...
        public NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder ByNewPrefabMethod(
            Func<InjectContext, UnityEngine.Object> prefabGetter, Install installerMethod)
        {
            var gameObjectInfo = new GameObjectCreationParameters();
        ...
        public NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder ByNewPrefabMethod(
            UnityEngine.Object prefab, Install installerMethod)
        {
        ...
        public NameTransformScopeConcreteIdArgConditionCopyNonLazyBinder ByNewPrefabResourceMethod(
            string resourcePath, Install installerMethod)
        {
